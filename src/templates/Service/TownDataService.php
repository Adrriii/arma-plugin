    ...
    public function process(array &$data): void
    {
        $data = array_replace_recursive($data, [
            ...
            'panda' =>  [
                ...
                'ranked' => [1,7,15],
                'orderBy' => 0,
                'help' => 'Pandämoniumstädte sind <strong>weitaus schwieriger</strong> als normale Städte! Dementsprechend sind auch die Belohnungen und Gewinnmöglichkeiten besser.<br /><strong>Du benötigst mindestens {splimit} Seelenpunkte</strong>, um in diesen Städten spielen zu dürfen.',
            ],
            'custom' => [
                'name'=>'custom',
                'label'=>'Private Stadt',
